...
# Endereços de email válidos devem seguir as seguintes regras:
...
# 🦜 As funções isalpha e isdigit podem ser utilizadas para verificar se uma letra ou palavra
# são compostas de somente caracteres ou dígitos. Exemplo : "1".isaplha() -> False , "a".isalpha() -> True
