...
# Claro que existem alguns problemas, uma vez que alguns números de telefone não formam uma palavra
...
# Curiosidade : A frase "The quick brown fox jumps over the lazy dog" é um pantograma
# (frase com sentido em que são usadas todas as letras do alfabeto de determinada língua) da língua inglesa.
